#line 1 "C:\\Users\\ScottPorter\\Documents\\git projects\\ManicMinerForArduinoUNO\\games\\Scramble\\Scramble\\engineDefs.h"
/*
...
#define PRESSED_START        (PRESSING_START    && (keyState.changed&BUTTON_START))
#define PRESSED_OPTION       (PRESSING_OPTION   && (keyState.changed&BUTTON_OPTION))
#define PRESSED_A            (PRESSING_A        && (keyState.changed&BUTTON_A))
#define PRESSED_B            (PRESSING_B        && (keyState.changed&BUTTON_B))
#define PRESSED_LEFT         (PRESSING_LEFT     && (keyState.changed&BUTTON_LEFT))
#define PRESSED_RIGHT        (PRESSING_RIGHT    && (keyState.changed&BUTTON_RIGHT))
#define PRESSED_UP           (PRESSING_UP       && (keyState.changed&BUTTON_UP))
#define PRESSED_DOWN         (PRESSING_DOWN     && (keyState.changed&BUTTON_DOWN))
